...
/**
 * Configures shadcn/ui for Next.js projects
 */
async function configureShadcnNext() {
  ...
  let setupMessage = 'Do you want to initialize shadcn/ui for Next.js?';
  ...
  if (answers.setupShadcn) {
    try {
      ...
      if (!hasConfig) {
        console.log('Initializing shadcn/ui for Next.js...');
        await runCommand('npx', ['shadcn@latest', 'init', '--template', 'next', '--yes']);
      ...
      console.log(chalk.green('\n✅ shadcn/ui setup complete for Next.js!'));
      console.log(chalk.yellow('\nYou can now use shadcn/ui components in your Next.js app:'));
...
module.exports = {
  command: 'shadcn-next',
  description: 'Configure shadcn/ui for Next.js projects',
  action: configureShadcnNext
};
